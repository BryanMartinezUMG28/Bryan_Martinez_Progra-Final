<%-- 
    Document   : index
    Created on : 12/11/2022, 07:47:31
    Author     : bryan
--%>
				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card shadow-lg">
						<div class="card-body p-5">
							...
							<form action="inicio.jsp" method="POST" class="needs-validation" novalidate="" autocomplete="off">
								<div class="mb-3">
						...
						<div class="card-footer py-3 border-0">
							<div class="text-center">
								Necesitas ayuda? <a href="register.html" class="text-dark">Pedir ayuda</a>
							</div>
						</div>
					</div>
